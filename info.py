...
# ============================
SESSION = environ.get('SESSION', 'Metrix_Filter_Bot')   # Session name for the bot
API_ID = int(environ.get('API_ID', '24638343')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'c16b13b73c2f2473b8e3cbcf2ab1d200')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://telegra.ph/file/fbb389a97ef10661beee4-de11627ad571e6c45e.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://telegra.ph/file/ef7c2f374f2881c7a429e-49cb2de5a66470e347.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', ''))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://telegra.ph/file/1a1f510d56b39f00d81e2-1e43b57637102943bc.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6272165202 8199195480').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003183636030').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003654984741'))  # Log channel id (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1003899456088")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aflahtbm:da9yNWm8Vhjqv1vl@cluster0.7mrpr1d.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'METRIXBOTZ') # Collection name (default: dreamcinezone_files)
...
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', False))  # Notification On (False) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-100'))  # Notification of sent to your channel
DREAMXBOTZ_IMAGE_FETCH = bool(environ.get('METRIXBOTZ_IMAGE_FETCH', False))  # On (False) / Off (False)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Metrix_Bot_Hub")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Metrix_Bot_Hub")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Metrix_Bot_Hub")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Metrix_Bot_Hub') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Metrix_Bot_Hub') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Metrix_Bot_Hub') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'metrixbotz'))
MULTI_CLIENT = False
name = str(environ.get('name', 'metrixbotz'))
